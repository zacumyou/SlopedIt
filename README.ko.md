...
**Release:** 1.0.0 · **Paradox Mods compatibility:** 1.6.*
...
Only standalone terrain decals are supported. Wall/attached decals and functional composite prefabs are excluded. This adjusts the decal's projection rotation; it does not deform its mesh. Sharp terrain changes may exceed the projection volume.
...
The user confirmed the existing feature works in game. Version 1.0.0 promotes the same behavior for publication; build and numerical tests are separate from new gameplay tests.
...
**버전:** 1.0.0 · **Paradox Mods 호환 표기:** 1.6.*
